...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_workers", type=int, default=1, help="Number of data loading workers per GPU")
    ...
    parser.add_argument("--save_every", type=int, default=1000, help="Save intermediate results every N samples")
    ...
    if torch.cuda.is_available():
        ...
        run_inference('cuda',args.world_size, args )
